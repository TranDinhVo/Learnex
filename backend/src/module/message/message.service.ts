...
import { DirectMessage } from '@/module/common/common.type';
...
export const messageService = {
  ...
  async getConversation(
    ...
    const messages = await db('direct_messages as dm')
      ...
      .where(function () {
        this.where({ 'dm.sender_id': userId, 'dm.receiver_id': otherUserId })
          .orWhere({ 'dm.sender_id': otherUserId, 'dm.receiver_id': userId });
      })
