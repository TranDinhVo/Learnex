  ...
  try {
    ...
    const posts = [
      {
        ...
        content:
          "Chào mừng các bạn sinh viên đến với cộng đồng học tập Learnex! Chúc mọi người học tập thật tốt 🚀.",
      },
      {
        id: uuidv4(),
        user_id: insertedUsers[1].id,
        content:
          "Có bạn nào có tài liệu ôn thi cuối kỳ môn Cấu trúc dữ liệu và giải thuật không? Cho mình xin với!",
      },
    ];
    ...
    const [room] = await db("rooms")
      .insert({
        ...
        privacy_mode: "public", // 👈 Đã sửa is_private thành privacy_mode
      })
      .returning("*");
