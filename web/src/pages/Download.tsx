  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-purple-600 selection:text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] block text-purple-400 font-semibold tracking-wider uppercase -mt-0.5">
                Mobile App
              </span>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center mb-28">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Trải nghiệm ứng dụng di động Learnex được thiết kế tối ưu cho trải
              nghiệm học tập của bạn. Tham gia phòng học thảo luận, luyện tập
              Flashcards tiện lợi, chia sẻ tài liệu và tương tác cùng cộng đồng
              học tập trực tuyến.
            </p>
                ...
                <div className="w-full h-full bg-slate-950 flex flex-col relative select-none">
                  ...
                  <div className="h-9 pt-2.5 px-6 flex justify-between items-center text-[10px] font-medium text-slate-400 z-20">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <svg className="w-3 h-3 fill-current" viewBox="0 0 24 24">
                        <path d="M12 3c-1.2 0-2.4.2-3.6.7L19.3 15c.5-1.2.7-2.4.7-3.6 0-5.5-4.5-10-10-10zM2.9 4.3L1.5 5.7l2.8 2.8C3.5 9.4 3 10.7 3 12c0 5.5 4.5 10 10 10 1.3 0 2.6-.5 3.6-1.3l2.7 2.7 1.4-1.4L2.9 4.3z" />
                      </svg>
                      {/* Battery */}
                  ...
                  <div className="px-4 py-3 flex items-center justify-between border-b border-slate-900/60 bg-slate-950/90 backdrop-blur-md">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-md bg-purple-600 flex items-center justify-center text-[11px] font-bold text-white">
                        L
                      </div>
                  ...
                  <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4 text-left">
                    ...
                    <div className="p-3.5 rounded-xl bg-gradient-to-r from-purple-900/35 to-indigo-900/35 border border-purple-500/10">
                      ...
                      <div className="text-[12px] text-white font-semibold mt-0.5">
                        Tiếp tục tiến độ học tập hôm nay nào
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="text-[10px] font-bold text-slate-400 tracking-wide uppercase mb-2">
                        Luyện Flashcard
                      </div>
                      <div className="p-4 rounded-xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800/80 text-center relative overflow-hidden">
                        <div className="absolute top-2 right-2 text-[8px] bg-indigo-500/10 text-indigo-400 px-1.5 py-0.5 rounded">
                          Từ vựng C1
                        </div>
                        <div className="text-[15px] font-bold text-white mt-2 mb-1">
                          Ambidextrous
                        </div>
        ...
        <div className="border-t border-slate-900 pt-20 mb-28">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-400 text-sm md:text-base">
              Learnex được xây dựng để cung cấp môi trường học tập xã hội trực
              tuyến liền mạch, tiện lợi và tăng hiệu quả tiếp thu kiến thức.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/30 border border-slate-900 hover:border-purple-500/30 hover:bg-slate-900/50 transition-all group duration-300">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Tạo và học từ vựng, thuật ngữ thông qua các bộ thẻ ghi nhớ tương
                tác. Hỗ trợ hệ thống thuật toán lặp lại ngắt quãng tối ưu.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/30 border border-slate-900 hover:border-indigo-500/30 hover:bg-slate-900/50 transition-all group duration-300">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Tham gia thảo luận nhóm bằng giọng nói và nhắn tin thời gian
                thực với cộng đồng. Hỗ trợ tạo phòng học riêng tư hoặc công
                khai.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/30 border border-slate-900 hover:border-blue-500/30 hover:bg-slate-900/50 transition-all group duration-300">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Kho tài liệu chuyên ngành phong phú được đóng góp bởi các học
                viên khác. Bạn có thể lưu trữ, đọc trực tiếp trên app di động.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/30 border border-slate-900 hover:border-pink-500/30 hover:bg-slate-900/50 transition-all group duration-300">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Được cập nhật ngay lập tức khi có tin nhắn mới trong phòng học
                của bạn, phản hồi trên bài đăng hoặc khi tài liệu quan trọng tải
                lên.
              </p>
            </div>
          </div>
        ...
        <div
          id="guide"
          className="border-t border-slate-900 pt-20 grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-start"
        >
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Bạn có thể quét mã QR để tải trực tiếp trên điện thoại Android của
              mình hoặc sao chép liên kết tải xuống để gửi cho bạn bè.
            </p>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/40 border border-slate-900 flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="space-y-3 text-center sm:text-left">
                <div className="text-xs font-semibold text-purple-400 uppercase tracking-wider">
                  Quét mã để tải nhanh
                </div>
                <p className="text-xs text-slate-400">
                  Sử dụng camera điện thoại hoặc ứng dụng quét mã QR để tải file
                  APK về máy.
                </p>
                <button
              ...
              <div className="divide-y divide-slate-900 text-sm">
                ...
                <div className="py-2.5 flex justify-between">
                  ...
                  <span className="text-emerald-400 flex items-center gap-1 text-xs">
                    <ShieldCheck size={14} /> Đã quét an toàn (Không
                    virus/malware)
                  </span>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 p-8 rounded-3xl bg-slate-900/20 border border-slate-900 space-y-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Vì file APK được cài đặt trực tiếp bên ngoài Google Play Store,
              bạn cần thực hiện một vài bước cấu hình nhỏ trên điện thoại để
              hoàn tất cài đặt.
            </p>
            ...
            <div className="space-y-6 relative before:absolute before:left-5 before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-900">
              ...
              <div className="relative pl-12">
                ...
                <p className="text-xs md:text-sm text-slate-400 leading-relaxed">
                  Bấm nút <strong>"Tải APK"</strong> ở đầu trang hoặc quét mã
                  QR. Trình duyệt trên thiết bị Android sẽ hiển thị cảnh báo bảo
                  mật tải file gây hại. Đừng lo lắng, hãy bấm{" "}
                  <strong>"Vẫn tải xuống" (Download anyway)</strong>.
                </p>
              </div>
              ...
              <div className="relative pl-12">
                ...
                <p className="text-xs md:text-sm text-slate-400 leading-relaxed">
                  Trước khi mở tệp, truy cập <strong>Cài đặt (Settings)</strong>{" "}
                  &rarr; <strong>Bảo mật (Security)</strong> (hoặc Quyền riêng
                  tư) &rarr; Tìm mục{" "}
                  <strong>
                    "Cài đặt ứng dụng không rõ nguồn gốc" (Install unknown apps)
                  </strong>{" "}
                  &rarr; Chọn trình duyệt của bạn (Chrome/Samsung Internet) và
                  gạt bật{" "}
                  <strong>
                    "Cho phép từ nguồn này" (Allow from this source)
                  </strong>
                  .
                </p>
              </div>
              ...
              <div className="relative pl-12">
                ...
                <h4 className="text-base font-bold text-white mb-1">
                  Tiến hành cài đặt và sử dụng
                </h4>
                <p className="text-xs md:text-sm text-slate-400 leading-relaxed">
                  Mở ứng dụng <strong>Quản lý tệp (Files)</strong> &rarr; Chọn
                  thư mục <strong>Tải về (Downloads)</strong> &rarr; Nhấp chọn
                  file <code>learnex.apk</code> &rarr; Chọn{" "}
                  <strong>"Cài đặt" (Install)</strong>. Sau khi hoàn tất, bạn có
                  thể mở ứng dụng Learnex ngay trên màn hình chính!
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/15 flex items-start gap-3">
              ...
              <div className="text-xs text-amber-300 leading-relaxed">
                <strong>Chú ý:</strong> Đối với một số dòng máy Oppo, Realme,
                Xiaomi, hệ thống bảo mật quét virus cục bộ sẽ hiển thị cảnh báo
                khi cài đặt APK. Đây là thủ tục chuẩn của hãng, file APK Learnex
                hoàn toàn an toàn và đã được ký mã hóa đầy đủ.
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-slate-900 bg-slate-950 px-6 py-12 text-center text-xs text-slate-500 relative z-10">
        <div className="max-w-7xl mx-auto space-y-4">
          ...
          <p>
            &copy; {new Date().getFullYear()} Learnex Corp. Bảo lưu mọi quyền
            lợi.
          </p>
