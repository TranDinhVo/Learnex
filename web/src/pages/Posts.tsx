...
export default function Posts() {
  ...
  const handleHide = async () => {
    ...
    try {
      await postsApi.hide(selectedPost._id);
  ...
  return (
    <div className="space-y-8">
      ...
      <ConfirmModal
        ...
        title="Ẩn bài viết"
        message="Bạn có chắc chắn muốn ẨN bài viết này? Bài viết sẽ bị ẩn khỏi bảng tin của sinh viên nhưng vẫn được lưu trữ trong quản trị."
      ...
      <ConfirmModal
        ...
        title="Xóa vĩnh viễn"
        message="Bạn có chắc chắn muốn XÓA VĨNH VIỄN bài đăng này? Hành động này sẽ xóa hoàn toàn hình ảnh, bình luận, lượt thích liên quan và KHÔNG THỂ khôi phục."
